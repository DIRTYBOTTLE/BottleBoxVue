...
export class B_Cesium {
    constructor(container, option) {
        ...
        Cesium.Camera.DEFAULT_VIEW_RECTANGLE = Cesium.Rectangle.fromDegrees(75, 0, 140, 60);
        const optionDefault = {
        ...
        this.viewer = new Cesium.Viewer('cesiumContainer', option)
        const tianImage = new Cesium.ProviderViewModel({
              name: '天地图影像',
              tooltip: '天地图影像地图源',
              iconUrl: require("./assets/tianimg.png"),
              category: '国内地图',
        ...
        const tianVector = new Cesium.ProviderViewModel({
          name: '天地图矢量',
          tooltip: '天地图矢量地图源',
          iconUrl: require("./assets/tianvec.png"),
          category: '国内地图',
          creationFunction: function () {
            const layer1 = new Cesium.WebMapTileServiceImageryProvider({
        ...
        const tianTerrain = new Cesium.ProviderViewModel({
          name: '天地图地形',
          tooltip: '天地图影像地图源',
          iconUrl: require("./assets/tianter.png"),
          category: '国内地图',
          creationFunction: function () {
            const layer1 = new Cesium.WebMapTileServiceImageryProvider({
        ...
        this.paint = new B_Paint(this.viewer)
    }
}